...
def format_as_string(transcript: TranscriptAnalysis) -> str:
    ...
    output.append(f"  Sentiment Score: {transcript.sentiment_score:.2f}")
    output.append(f"  Sentiment Label: {transcript.sentiment_label.upper()}\n")
...
def format_as_markdown(transcript: TranscriptAnalysis) -> str:
    ...
    output.append("## Sentiment Analysis")
    output.append(f"- **Sentiment Score:** {transcript.sentiment_score:.2f}")
    output.append(f"- **Sentiment Label:** {transcript.sentiment_label.capitalize()}\n")
